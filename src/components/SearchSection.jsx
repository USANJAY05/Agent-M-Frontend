...
const SearchSection = ({rightSearch,setRightSearch}) => {
  return (
    <div className='h-full w-96 border-l p-3 pt-10 flex flex-col gap-5'>
        <div className='relative w-full'>
            <input type="search" className='outline-none border w-full text-lg pl-10 pr-1 py-2 bg-inherit dark:text-white' placeholder='Search by PO number or sup. ' />
